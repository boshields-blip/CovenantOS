...
The Hebrew word *am* (עַם) appears approximately 1,800 times in the Hebrew Bible. It is the most common word for *people*, *nation*, or *kindred* in the entire text. It almost always refers to a specific, particular, embodied group — not an abstraction.

*Am YHWH* — "the people of YHWH" — is not a generic religious category. It is a designation for a specific community with specific obligations, specific practices, a specific land, a specific history, and a specific future. To be part of *am YHWH* is to be part of a people who were slaves in Egypt, who crossed the sea, who received the Torah at Sinai, who live under covenant blessings and curses, and who are called to embody right-orderedness (*mishpat* and *tzedek*) in the sight of the nations.

The *am* is always:
- **Specific** — a named people in a named place with a named history
- **Relational** — membership is in relationship, not merely by credential
- **Embodied** — land, language, practice, and shared life are constitutive, not decorative
- **Obligated** — being part of the *am* means accepting the covenant's obligations, not only its blessings

## What makes a people (covenantally)
...
## The contrast with consumer identity
...
The nation-state is a modern form with a short history. Covenant peoples — the households and congregations and communities bound by obligation and shared life — have existed across many state boundaries and long after states have dissolved.

## The church as a new covenant people
...
- With genuine obligations — to one another, to the poor, to the stranger, to the mission
- With shared practices — baptism, the Lord's Supper, the public reading of Scripture, mutual correction and encouragement
- With mutual accountability — not merely pastoral accountability from above, but the horizontal accountability of members to one another
- With a specific mission in the world — to embody the covenant community that the nations will see and desire
...
Peoplehood is not designed; it is grown. The conditions that allow it to take root are:

- **Stability and rootedness** — staying in a place long enough to be known and to know
- **Shared practices** — regular rhythms that bring the same people together repeatedly: the shared table, the shared market, the shared feast, the shared work
- **Shared story** — the recovery of particular history: the stories of this land, this community, this congregation, these families across generations
- **Shared accountability** — the willingness to hold and receive correction, to repair rather than exit, to stay when staying is hard
- **Shared hope** — a common future that is bigger than individual comfort or tribal victory
